...
Por defecto Morgan envía la salida exclusivamente a la consola, algo asi:
 Morgan --->[logs]---> consola
Lo que haremos a continuación sera definir una función llamada "write" que será parte de un
objeto que se asignará a la propiedad stream del logger, esta función será capaz de recibir
